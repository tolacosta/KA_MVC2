...
public class AcionListForumUsers implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		ClsPagination pagin = new ClsPagination(1,30,0);
		...
		String listuser_json = new Gson().toJson(hash);
		System.out.println(listuser_json);
		response.getWriter().write(listuser_json);
